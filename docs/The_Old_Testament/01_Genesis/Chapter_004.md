...
(GENESIS_4_18)=
18. And unto {ref}`Enoch<WHO_Enoch>` was born {ref}`Irad<WHO_Irad>`: and {ref}`Irad<WHO_Irad>` begat {ref}`Mehu'ja-el<WHO_Mehujael>`: and {ref}`Mehu'ja-el<WHO_Mehujael>` begat {ref}`Methu'sa-el<WHO_Methusael>`: and {ref}`Methu'sa-el<WHO_Methusael>` begat {ref}`Lamech<WHO_Lamech>`.
(GENESIS_4_19)=
19. And {ref}`Lamech<WHO_Lamech>` took unto him two wives: the name of the one *was* {ref}`Adah<WHO_Adah>`, and the name of the other {ref}`Zillah<WHO_Zillah>`.
(GENESIS_4_20)=
20. And {ref}`Adah<WHO_Adah>` bare {ref}`Jabal<WHO_Jabal>`: he was the father of such as dwell in tents, and of *such as have* cattle.
(GENESIS_4_21)=
21. And his brother's name *was* {ref}`Jubal<WHO_Jubal>`: he was the father of all such as handle the harp and organ.
(GENESIS_4_22)=
22. And {ref}`Zillah<WHO_Zillah>`, she also bare {ref}`Tu'bal-cain<WHO_Tubalcain>`, an instructor of every artificer in brass and iron: and the sister of {ref}`Tu'bal-cain<WHO_Tubalcain>` *was* {ref}`Na'amah<WHO_Naamah>`.
(GENESIS_4_23)=
23. And {ref}`Lamech<WHO_Lamech>` said unto his wives, {ref}`Adah<WHO_Adah>` and {ref}`Zillah<WHO_Zillah>`, hear my voice; ye wives of {ref}`Lamech<WHO_Lamech>`, hearken unto my speech: for I have slain a man to my wounding, and a young man to my hurt.
(GENESIS_4_24)=
24. If {ref}`Cain<WHO_Cain>` shall be avenged sevenfold, truly {ref}`Lamech<WHO_Lamech>` seventy and sevenfold.
(GENESIS_4_25)=
