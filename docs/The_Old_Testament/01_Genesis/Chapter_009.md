...
1. And you, be ye fruitful, and multiply; bring borth abundantly in the earth, and multiply therein.
1. And God spake unto {ref}`Noah<WHO_Noah>`, and to his sons with him, saying,
...
1. And God said unto {ref}`Noah<WHO_Noah>`, This *is* the token of the covenant, which I have established between me and all flesh that *is* upon the earth.
(GENESIS_9_18)=
18. And the sons of {ref}`Noah<WHO_Noah>`, that went forth of the ark, were {ref}`Shem<WHO_Shem>`, and {ref}`Ham<WHO_Ham>`, and {ref}`Japheth<WHO_Japheth>`: and {ref}`Ham<WHO_Ham>` *is* the father of {ref}`Canaan<WHO_Canaan>`.
(GENESIS_9_19)=
19. These *are* the three sons of {ref}`Noah<WHO_Noah>`, and of them was the whole earth overspread.
(GENESIS_9_20)=
20. And {ref}`Noah<WHO_Noah>` began *to be* an husbandman, and he planted a vineyard:
(GENESIS_9_21)=
21. and he drank of the wine, and was drunken; and he was uncovered within his tent.
(GENESIS_9_22)=
22. And {ref}`Ham<WHO_Ham>`, the father of {ref}`Canaan<WHO_Canaan>`, saw the nakedness of his father, and told his two brethren without.
1. And {ref}`Shem<WHO_Shem>` and {ref}`Japheth<WHO_Japheth>` took a garment, and laid *it* upon both their shoulders, and went backward, and covered the nakedness of their father; and their faces *were* backward, and they saw not their father's nakedness.
...
name: Irviz_Relief
---
Modern scientific investigation indicated that [ancient Anatolia](https://en.wikipedia.org/wiki/Prehistory_of_Anatolia), which is close to [Ararat](https://en.wikipedia.org/wiki/Mount_Ararat), was a center of vine-growing. In an 8th century B.C. relief hewn in mountain rock in southern [Asia Minor](https://en.wikipedia.org/wiki/Anatolia), [King Warpalawa](https://www.hittitemonuments.com/ivriz/) of Tubal, a land with the same as a grandson of Noah (Gen. 10:2), prays to [Tarhund](https://en.wikipedia.org/wiki/Tar%E1%B8%ABunz), the god of fertility. The god is girded with vine clusters and holds wheat stalks and a bunch of grapes as symbols of plenty. (Klaus-Peter Simon, [CC by 3.0](https://creativecommons.org/licenses/by/3.0), [Image courtesy](https://commons.wikimedia.org/wiki/File:IvrizRelief.JPG), via Wikimedia Commons. Accessed on October 30, 2025.)
```

{ref}`And Noah began to be a husbandman, and he planted a vineyard.<GENESIS_9_20>` -- {ref}`GENESIS<GENESIS>` {ref}`8<GENESIS_9>`:{ref}`4<GENESIS_9_20>`