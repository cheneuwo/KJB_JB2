...
(The name *Adam* first appeared in  {ref}`Genesis<GENESIS>` {ref}`2<GENESIS_2>`:{ref}`19<GENESIS_2_19>`)

Adam was the **first** men in bible, created by Lord God. Together with {ref}`Eve<WHO_Eve>`, he fathered {ref}`Cain<WHO_Cain>` and {ref}`Abel<WHO_Abel>`. At the age of {ref}`130 years old<GENESIS_5_3>`, he fathered {ref}`Seth<WHO_Seth>`. Adam also fathered {ref}`other sons and daughters<GENESIS_5_4>`. {ref}`Adam died at the age of 930<GENESIS_5_5>`.
